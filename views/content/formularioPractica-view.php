            ...
            <form action="" method="POST" class="advance_search_query booking-form">
                <div class="form-bg seven">
                    <div class="form-container2">
                        ...
                        <div class="form-group2">
                            <label>Precio</label>
                            <input name="priceAlquiler"  placeholder="$Valor de la casa por noche">
                        </div><!-- /.form-group -->
                        <div class="form-group2">
                            <label>Dirección</label>
                            <input name="location"  placeholder="Ubicación del inmueble">
                        </div><!-- /.form-group -->

                        <div class="form-group2">
                            <label>Fecha llegada</label>
                            <input type="date" name="startDateAvail"><br><br>
