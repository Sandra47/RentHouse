                                ...
                                <div id="mobile-main-nav" class="main-navigation slideLeft">
                                    <div class="menu-wrapper">
                                        ...
                                        <div class="left-content">
                                            <ul>
                                                <li>
                                                    <a href="#"><i class="fa fa-phone-square"></i>Reservar
                                                        - 300-2323232</a>
                                                </li>
                                                <li>
                                                    <a href="#" class="cd-signin"><i
                                                            class="fa fa-address-book"></i>Ingresar / Registro</a>
                                                </li>
                                            </ul>
                                        </div><!-- /.left-content -->
                                    </div>
    ...
    <header class="header-bottom-content bg-nero hidden-xs hidden-sm">
        ...
        <div class="slider-area">
            <div class="pogoSlider">
                <div class="pogoSlider-slide" data-transition="expandReveal" data-duration="1000"
                    style="background-image:url(assets/images/gallery/banner1.jpg);">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="heading-content-three">
                            <h2 class="title">Encuentra la mejor casa o Apartamento &amp; para ti</h2>
                            <h5 class="sub-title">Buscar <span>Casa</span></h5>
                        ...
                        <form action="#" method="get" class="advance_search_query">
                            <div class="form-content">
                                <div class="form-group">
                                    <label>Sector</label>
                                    <input type="text" name="FirstName" placeholder="En donde quieres arrendar">
                                </div>
                                <!-- /.form-group 
                                <div class="form-group">
                                    <label>Tipo</label>
                                ...
                                <div class="form-group">
                                    <label>Para</label>
                                    <select>
                                        <option value="volvo">Familia</option>
                                        <option value="saab">una persona</option>
                                        <option value="mercedes">Pareja</option>
                                        <!-- <option value="audi">Audi</option> -->
                                    </select>
                                </div><!-- /.form-group -->
                            </div><!-- /.form-content -->
                            <button type="submit" class=" button nevy-button">Ver disponibilidad</button>
                    ...
                    <div class="col-md-10">
                        <div class="tab-content">
                                ...
                                <div class="col-md-6">
                                    <div class="text-content">
                                        <p>Andrés Garrido es un emprendedor que lleva varios años trabajando en su
                                            ...
                                            y la materializó a través de un MVP: abrió el instagram de su negocio y por
                            ...
                            <div role="tabpanel" class="tab-pane fade row" id="messages">
                                <div class="col-md-6">
                                    <div class="text-content">
                                        <p>Obten el mejor servicio y un inmueble en perfectas condiciones para ti y para
                                ...
                                <div class="col-md-6">
                                    <div class="image-content">
                                        <img src="assets/images/gallery/about-image.jpg" alt="about" />
                                    </div><!-- /.text-content -->
                                </div><!-- /.col-md-6 -->
                            </div> <!-- /.messages -->
                        </div> <!-- /.tab-content -->
        ...
        <div class="apartments-area bg-gray-color">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="heading-content-one border">
                            <h2 class="title">Casas &amp; Apartamentos</h2>
                ...
                <a href="#" class="button nevy-button">todos los Apartmentos</a>
            </div><!-- /.container -->
        </div><!-- /.Apartments-area-->

        <!-- ====== Fun Facts Area======= -->
        <div class="fun-fects-area" style="background-color:gray">
            <div class="container">
                <div class="stat">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="milestone-counter">
                            <h3 class="stat-count highlight" data-form="1" data-to="2500" data-speed="3000">2500</h3>
                            <div class="milestone-details">Clientes</div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="milestone-counter">
                            <h3 class="stat-count highlight" data-form="1" data-to="3055" data-speed="3000">3055</h3>
                            <div class="milestone-details">Reserva</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="milestone-counter">
                        ...
                        <div class="milestone-details">Apartamento</div>
                    </div>
                </div>
            </div><!-- stat -->
        </div><!-- /.container -->
        ...
        <!-- ====== Gallery Area ====== -->
        <div id="galeria" class="gallery-area">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="gallery-left-content">
                                <div class="row">
                                    <div class="col-md-4 col-sm-6 col-xs-6">
                                        <a class="image-pop-up" href="assets/images/gallery/imagen cuarto.webp">
                                            <img src="assets/images/gallery/gallery-one.png" alt="gallery" />
                                        </a>
                                    </div><!-- /.col-md-4 -->
                                    <div class="col-md-4 col-sm-6 col-xs-6">
                                        <a class="image-pop-up" href="assets/images/gallery/imagen1.jpg">
                                            <img src="assets/images/gallery/gallery-two.png" alt="gallery" />
                                        </a>
                                    </div><!-- /.col-md-4 -->
                                    <div class="clearfix visible-xs-block"></div>
                                    <div class="col-md-4 col-sm-6 col-xs-6">
                                        <a class="image-pop-up" href="assets/images/gallery/imagen2.jpg">
                                            <img src="assets/images/gallery/gallery-three.png" alt="gallery" />
                                        </a>
                                    </div><!-- /.col-md-4 -->
                                    <div class="col-md-4 col-sm-6 col-xs-6">
                                        <a class="image-pop-up" href="assets/images/gallery/imagen3.jpg">
                                            <img src="assets/images/gallery/gallery-four.png" alt="gallery" />
                                        </a>
                                    </div><!-- /.col-md-4 -->
                                    <div class="clearfix visible-xs-block"></div>
                                    <div class="col-md-4 col-sm-6 col-xs-6">
                                        <a class="image-pop-up" href="assets/images/gallery/images.jpeg">
                                            <img src="assets/images/gallery/gallery-five.png" alt="gallery" />
                                        </a>
                                    </div><!-- /.col-md-4 -->
                                    <div class="col-md-4 col-sm-6 col-xs-6">
                                        <a class="image-pop-up" href="#">
                                            <img src="assets/images/gallery/images 5.jpeg" alt="gallery" />
                                        </a>
                                    </div><!-- /.col-md-4 -->
                                </div><!-- /.row -->
                            </div><!-- /.left-content -->
                        ...
                        <div class="col-md-5">
                            <div class="gallery-right-content">
                                ...
                                <p>Los mejores Apartemanetos para ti y tu familia los encuentras aquí,
                                    cnoce nuestro portafolio y las ofertas que tenemos para ti.</p>
                                <a href="gallery.html" class="button nevy-button">todas las fotos</a>
                            </div><!-- /.right-content -->
                        </div><!-- /.col-md-5 -->
                    </div><!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-content-two available">
                                <h2 class="title">Estamos disponibles<br /> Para ti 24 horas al día, 7 días a la semana
                                </h2>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="map-left-content">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3977.3473581642306!2d-75.6766886856766!3d4.5313148443657765!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e38f5ae1fc5b765:0x9eded8eab2bbdba1!2zQXYuIEJvbMOtdmFyICMjMjMtMjcsIEFybWVuaWEsIFF1aW5kw61vLCBDb2xvbWJpYQ!5e0!3m2!1ses!2sus!4v1617054580027!5m2!1ses!2sus"
                        ...
                        <div class="col-md-5">
                            <div class="map-right-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="contact">
                                            <h4><i class="fa fa-envelope"></i>Correo Electronico</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        <div class="contact">
                                            <h4><i class="fa fa-phone-square"></i>Contacto</h4>
                                            <p>+57 300 2323232</p>
                                        </div><!-- /.contact -->
                                    </div><!-- /.col-md-6 -->
                                    <div class="col-md-6 col-sm-6">
